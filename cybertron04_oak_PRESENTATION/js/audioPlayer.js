{
  class AudioPlayer extends HTMLElement {
    ...
    style() {
        let iconsAddress = "https://ds604.neocities.org/webcomponents/BFS_AudioPlayer/audio-player-icon-sprite.png"
      return `
      <style>
        :host {
          width: 100%;
        ...
        * {
        ...
        .play-btn {
            ...
            min-width: 30px;
            height: 30px;
            background: url("${iconsAddress}") 0 center/500% 100% no-repeat;
            appearance: none;
            border: none;
        ...
        .play-btn.playing {
            background: url("${iconsAddress}") 25% center/500% 100% no-repeat;
        }
        ...
        .volume-bar {
            ...
            min-width: 30px;
            height: 30px;
            background: url("${iconsAddress}") 50% center/500% 100% no-repeat;
            position: relative;
        }
        
        .volume-bar.half {
            background: url("${iconsAddress}") 75% center/500% 100% no-repeat;
        }
        .volume-bar.over {
            background: url("${iconsAddress}") 100% center/500% 100% no-repeat;
        }
